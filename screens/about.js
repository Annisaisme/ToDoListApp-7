      ...
      <Center>
        ...
        >
          <AlertDialog.Content>
            ...
            <AlertDialog.Body>
              This action will delete all todo list data. Data that has been deleted cannot be restored!
            </AlertDialog.Body>
            <AlertDialog.Footer>
    ...
    <Box flex={1}>
      ...
      <ScrollView px={3} py={5}>
        <Box>
          ...
          <Text mt={3}>
            This is a simple todo list application to use for learning AsyncStorage implementation in react native.
          </Text>
        </Box>
